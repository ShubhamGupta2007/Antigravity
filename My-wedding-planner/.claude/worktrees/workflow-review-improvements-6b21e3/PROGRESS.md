...
- (2026-07-11) Built the visual color-coded horizontal stacked progress allocation strip ("Where the money goes") with allocation percentage legend on `/budget` planner tab.
